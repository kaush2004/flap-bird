...
pygame.display.set_caption('Hi! Lets Play the game!')
...
# bg = pygame.transform.scale(bg, (500,0.8*512))
...
flappybird_img = pygame.transform.scale(flappybird_img, (200,100))
